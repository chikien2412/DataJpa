...
public interface GenreRepository extends JpaRepository<Genre, Long> {
    ...
    @Query("SELECT g FROM Genre g WHERE g.genreId = (SELECT a.genre.genreId FROM Article a GROUP BY a.genre.genreId ORDER BY COUNT(a.postId) DESC)")
    List<Genre> findMaxArticle();
}
