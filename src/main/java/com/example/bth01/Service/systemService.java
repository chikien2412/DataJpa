...
public class systemService {
    ...
    public List<Article> getAllArticleAndGenre(){
        return articleRepository.findArticlesByAll();
    }
    ...
    public List<Article> getArticlesByTitleOrSongTitleContainingKeywords(){
        return articleRepository.findArticlesByTitleOrSongTitleContainingKeywords("yêu", "thương", "anh", "em");
    }
    ...
    public  List<Genre> getMaxArticle() {
        return genreRepository.findMaxArticle();
    }
    //Author
